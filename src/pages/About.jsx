        ...
        <div className="w-full max-w-[100vw] overflow-x-hidden">
            <div className="grid md:grid-cols-2 mt-6 md:mt-10 px-4 md:px-16 justify-center items-center">
                <div className="flex flex-col gap-4 md:gap-6 z-10 order-2 md:order-1">
                   ...
                   <a href="/desafios" className="mt-6 md:mt-10 bg-marrom text-bege px-8 md:px-16 py-3 rounded-full hover:bg-marromHover hover:cursor-pointer transition-all duration-200 w-64 text-center">
                        Se desafie!
                    </a>
                </div>
                <div className="flex justify-center md:justify-end items-start md:pr-8 order-1">
                    <img
                        src={logo}
                ...
                <div className="md:col-span-2 mt-8 md:mt-20 w-full order-3">
                    <Developeres />
                </div>
                
                <div className="flex flex-col justify-center items-start mt-8 md:mt-10 w-full px-0 gap-4 md:gap-6 md:col-span-2 order-4">
                ...
                <div className="flex flex-col justify-center items-start w-full px-0 gap-4 md:gap-6 z-10 mt-8 md:mt-10 md:col-span-2 order-5">
                    <h1 className="text-[36px] md:text-[80px] font-abril text-tittle leading-tight">
